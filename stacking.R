...
weights <- c(GAM = 0.2837838 , BRT = 0.3738739, RF = 0.3738739)#number obtained from Stack Ensemble.R
...
saveRDS(RWMse_predictions,"D:/ES-test/stackRWMse_glopred.rds")
...
weights2 <- c(GAM = 0.000001 , BRT = 0.000001 , RF = 0.999998)#number obtained from Stack Ensemble.R
...
saveRDS(CWMse_predictions,"D:/ES-test/stackCWMse_glopred.rds")
CWMse_raster <- template_raster
values(CWMse_raster) <- CWMse_predictions
writeRaster(CWMse_raster, filename = "D:/ES-test/stackCWMse_glopred.tif", format = "GTiff", overwrite = TRUE)
...
saveRDS(stacked_predictions2,"D:/ES-test/stackCWM_glopred.rds")
...
saveRDS(stacked_predictions,"D:/ES-test/stackRWM_glopred.rds")
